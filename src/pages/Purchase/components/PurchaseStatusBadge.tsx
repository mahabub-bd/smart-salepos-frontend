...
import { PurchaseOrderStatus, PurchaseStatus } from "../../../types";
...
const PurchaseStatusBadge: React.FC<PurchaseStatusBadgeProps> = ({
    ...
    const statusMap: Record<string, { color: "warning" | "info" | "success" | "error" | "primary" | "light" | "dark"; label: string }> = {
    ...
    const { color, label } = statusMap[status] || { color: "light", label: status };
