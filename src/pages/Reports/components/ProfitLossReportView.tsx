...
export default function ProfitLossReportView() {
  ...
  const [fetchReport, { isLoading, isError }] = useLazyGetProfitLossReportQuery();
  ...
  const handleGenerateReport = async () => {
    ...
    try {
      ...
      toast.error(error?.data?.message || "Failed to generate profit & loss report");
    }
  };
    ...
    <>
      ...
      {isModalOpen && reportData && (
        <Modal
          ...
          title="Profit & Loss Report Details"
          className="max-w-4xl"
        >
