...
export default function CustomerDetail({ customerId }: Props) {
    ...
    const summary = {
        ...
        totalPaid: sales.reduce((s: number, v: any) => s + Number(v.paid_amount), 0),
        ...
        <>
            ...
            <DetailCard title="Customer Information">
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                    ...
                    <Info
                        ...
                        value={
                            <span
                                className={`px-2 py-1 text-xs rounded ${customer.status ? "bg-green-100 text-green-600" : "bg-red-100 text-red-600"
                                    }`}
                            >
            ...
            <DetailCard title="Account Information">
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                    ...
                    <Info label="Account Number" value={customer.account?.account_number} />
